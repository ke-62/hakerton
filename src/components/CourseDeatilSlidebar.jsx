...
const CourseDetailSidebar = ({ selectedCourse, onRechooseCourses }) => {
  if (!selectedCourse) {
    return (
      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-[#FBBAB7] to-[#F49795] hover:from-[#F49795] hover:to-[#EA7274] text-white py-4 rounded-xl font-bold shadow-lg shadow-[#FBBAB7]/30 transition-all"
          >
            과목 다시 선택하기
          </button>
        </div>
